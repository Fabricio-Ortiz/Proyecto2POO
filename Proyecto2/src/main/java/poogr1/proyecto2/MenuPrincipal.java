...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    public MenuPrincipal(MovimientosHechos pMovimientosHechos, MovimientosBorrados pMovimientosBorrados){
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MovimientosHechos pMovimientosHechos = new MovimientosHechos();
                MovimientosBorrados pMovimientosBorrados = new MovimientosBorrados();
                new MenuPrincipal(pMovimientosHechos, pMovimientosBorrados).setVisible(true);
            }
        });
    }
